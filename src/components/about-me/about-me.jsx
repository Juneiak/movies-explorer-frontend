      ...
      <div className='about-me__content'>
        ...
        <div className='main-paage__about'>
          ...
          <ul className='main-page__link-list'>
            <li className='main-page__list-element'><a className='app__link-animation main-page__link' href='https://ru-ru.facebook.com/' target='_blank'>Facebook</a></li>
            <li className='main-page__list-element'><a className='app__link-animation main-page__link' href='https://github.com/' target='_blank'>Github</a></li>
          </ul>
